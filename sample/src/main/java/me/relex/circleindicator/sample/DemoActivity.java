...
import me.relex.circleindicator.sample.fragment.InfiniteViewPagerFragment;
...
public class DemoActivity extends AppCompatActivity {
    ...
    public static class DemoListFragment extends Fragment implements View.OnClickListener {
        ...
        @Override public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
            ...
            view.findViewById(R.id.demo_infinite_adapter).setOnClickListener(this);
        }
        ...
        @Override public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.demo_dynamic_adapter:
                    ...
                    break;
                case R.id.demo_infinite_adapter:
                    navigateToFragment(InfiniteViewPagerFragment.class.getName());
                    break;
            }
        }
